 ...
 * @author admin
 */
public class ThongTinChiTietKhuyenMaiPanel extends javax.swing.JPanel {
    ...
    public static void fetchAllDonHang(){
        ...
        GUI.KhuyenMai.ChiTietKhuyenMaiJPanel.currentDonHangList.forEach(DonHang -> {
    ...
    public ThongTinChiTietKhuyenMaiPanel() {
        initComponents();
    ...
    lblConLai.setText(Integer.parseInt(GUI.KhuyenMai.ChiTietKhuyenMaiJPanel.currentChiTietKhuyenMai.getSoLuong())-Integer.parseInt(GUI.KhuyenMai.ChiTietKhuyenMaiJPanel.currentChiTietKhuyenMai.getSoLuongDaDung())+"");
    lblDaDung.setText(GUI.KhuyenMai.ChiTietKhuyenMaiJPanel.currentChiTietKhuyenMai.getSoLuongDaDung());
    lblPhanTramKhuyenMai.setText(GUI.KhuyenMai.ChiTietKhuyenMaiJPanel.currentChiTietKhuyenMai.getPhanTramKhuyenMai());
    lblGiaTienKhuyenMai.setText(GUI.KhuyenMai.ChiTietKhuyenMaiJPanel.currentChiTietKhuyenMai.getGiaTienKhuyenMai());
    lblGiaTriSuDungToiThieu.setText(GUI.KhuyenMai.ChiTietKhuyenMaiJPanel.currentChiTietKhuyenMai.getGiaTriToiThieuSuDung());
    lblGiamToiDa.setText(GUI.KhuyenMai.ChiTietKhuyenMaiJPanel.currentChiTietKhuyenMai.getGiaTriGiamToiDa());
    lblThoiGianBatDau.setText(DateTime.TimestampToDateString(GUI.KhuyenMai.ChiTietKhuyenMaiJPanel.currentChiTietKhuyenMai.getThoiGianBatDauSuDung(),0));
    lblThoiGianKetThuc.setText(DateTime.TimestampToDateString(GUI.KhuyenMai.ChiTietKhuyenMaiJPanel.currentChiTietKhuyenMai.getThoiGianKetThucSuDung(),0));
        ...
        pnlThongTinLayout.setHorizontalGroup(
            ...
            .addGroup(pnlThongTinLayout.createSequentialGroup()
                ...
                .addGroup(pnlThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(pnlThongTinLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        if(row < tblDonHang.getRowCount() && row >= 0 && column < tblDonHang.getColumnCount() && column >= 0){
                    ...
                    currentChiTietDonHangList.forEach(ChiTietDonHang->{
                        ...
                        this.removeAll();
                            ...
                            this.add(new ChiTietDonHangTrongChiTietJPanel());
                            this.validate();
                            this.repaint();
                        }
    ...
    private void lblXemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblXemMouseClicked
       if (SwingUtilities.isLeftMouseButton(evt)){ 
           currentSanPhamKhuyenMaiList = quanlycuahangsach.quanlycuahangsach.SanPhamKhuyenMaiBUS.getSanPhamKhuyenMai(GUI.KhuyenMai.ChiTietKhuyenMaiJPanel.currentChiTietKhuyenMai.getMaChiTietKhuyenMai());
            
           new XemSanPhamJFrame().setVisible(true);}
