 ...
 * @author admin
 */
public class ChiTietDonHangTrongChiTietJPanel extends javax.swing.JPanel {
    ...
    listTableModel.setRowCount(0);
        for(int i=0;i<GUI.KhuyenMai.ThongTinChiTietKhuyenMaiPanel.currentChiTietDonHangList.size();i++){
            Vector row = new Vector();
            SanPhamDTO sanpham = GUI.KhuyenMai.ThongTinChiTietKhuyenMaiPanel.currentSanPhamList.get(i);
            ChiTietDonHangDTO chitietdonhang = GUI.KhuyenMai.ThongTinChiTietKhuyenMaiPanel.currentChiTietDonHangList.get(i);
    ...
    public ChiTietDonHangTrongChiTietJPanel() {
        initComponents();
    ...
    public void setData(){
        KhachHangDTO KhachHang = quanlycuahangsach.quanlycuahangsach.KhachHangBUS.getByMaKhachHang(GUI.KhuyenMai.ThongTinChiTietKhuyenMaiPanel.currentDonHang.getMaKhachHang());
            ...
            lblMaDonHang.setText(GUI.KhuyenMai.ThongTinChiTietKhuyenMaiPanel.currentDonHang.getMaDonHang());
            lblNgayDat.setText(DateTime.TimestampToDateString(GUI.KhuyenMai.ThongTinChiTietKhuyenMaiPanel.currentDonHang.getNgayXuat(),0));
            lblMaGiamGia.setText(GUI.KhuyenMai.ChiTietKhuyenMaiJPanel.currentChiTietKhuyenMai.getMaCode());
            lblTamTinh.setText(changeCurrency(GUI.KhuyenMai.ThongTinChiTietKhuyenMaiPanel.currentDonHang.getTamTinh()));
            lblGiamGia.setText(changeCurrency(GUI.KhuyenMai.ThongTinChiTietKhuyenMaiPanel.currentDonHang.getGiamGia()));
            lblPhiVanChuyen.setText(changeCurrency(GUI.KhuyenMai.ThongTinChiTietKhuyenMaiPanel.currentDonHang.getPhiVanChuyen()));
            lblTongTien.setText(changeCurrency(GUI.KhuyenMai.ThongTinChiTietKhuyenMaiPanel.currentDonHang.getTongTien()));
    }
    /**
