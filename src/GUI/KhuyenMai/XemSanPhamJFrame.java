 ...
 * @author admin
 */
public class XemSanPhamJFrame extends javax.swing.JFrame {
    ...
    public static void fetchAllSanPhamKhuyenMai() {
        ...
        if(GUI.KhuyenMai.ThongTinChiTietKhuyenMaiPanel.currentSanPhamKhuyenMaiList == null){
        ...
        GUI.KhuyenMai.ThongTinChiTietKhuyenMaiPanel.currentSanPhamKhuyenMaiList.forEach(SanPhamKhuyenMai -> {
            Vector row = new Vector();
