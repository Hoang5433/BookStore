 ...
 * @author admin
 */
public class ChiTietThongKeKhuyenMai extends javax.swing.JPanel {
    ...
    public ChiTietThongKeKhuyenMai() {
        initComponents();
        setComboBox();
    ...
    private void pnlXuatExcelThangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlXuatExcelThangMouseClicked
        ...
        ThongKeKhuyenMaiThangExcel.ExportExcelFile(path, DataThongKeKhuyenMai.ThongKeKhuyenMaiThangExcel(cbxNam.getSelectedItem().toString()));
        SweetAlert.showSweetAlert(new JFrame(), "Hoàn tất", "Xuất dữ liệu thành công", 0);
        } catch (IOException ex) {
            Logger.getLogger(ChiTietThongKeKhuyenMai.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void pnlXuatExcelQuyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlXuatExcelQuyMouseClicked
        try {
            ...
            ThongKeKhuyenMaiQuyExcel.ExportExcelFile(path,  DataThongKeKhuyenMai.ThongKeKhuyenMaiQuyExcel(cbxNam.getSelectedItem().toString()));
            SweetAlert.showSweetAlert(new JFrame(), "Hoàn tất", "Xuất dữ liệu thành công", 0);
        } catch (IOException ex) {
            Logger.getLogger(ChiTietThongKeKhuyenMai.class.getName()).log(Level.SEVERE, null, ex);
        }
