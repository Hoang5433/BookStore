 ...
 * @author khanh
 */
public class ThongKeKhuyenMaiThangExcel extends ObjectExcel{
    public static final int CELL_NAM = 0;
    public static final int CELL_THANG  = 1;
    public static final int CELL_TONGCTKM  = 2;
    public static final int CELL_TONGChiTietKM  = 3;
    ...
    cellHeader.setCellValue("Thống kê khuyến mãi theo tháng");    
    ...
    cellHeader = headerRow.createCell(CELL_TONGCTKM);
    cellHeader.setCellStyle(headerCellStyle);
    cellHeader.setCellValue("Tổng số chương trình khuyến mãi");

    cellHeader = headerRow.createCell(CELL_TONGChiTietKM);
    cellHeader.setCellStyle(headerCellStyle);
    cellHeader.setCellValue("Tổng số chi tiết khuyến mãi");
    ...
    for (int i = 0;i < list.size();i++){
        ...
        cell = row.createCell(CELL_TONGCTKM);
        cell.setCellValue(list.get(i)[2]);

        cell = row.createCell(CELL_TONGChiTietKM);
