...
public class ThongKeDonHangQuyExcel extends ObjectExcel{
    ...
    cellHeader.setCellValue("Thống kê đơn hàng theo quý");    
    ...
    cellHeader.setCellStyle(headerCellStyle);
    cellHeader.setCellValue("Tổng số đơn hàng");

    cellHeader = headerRow.createCell(CELL_DONHANGTHANHCONG);
    cellHeader.setCellStyle(headerCellStyle);
    cellHeader.setCellValue("Tổng số đơn hàng thành công");

    cellHeader = headerRow.createCell(CELL_DONHANGBIHUY);
    cellHeader.setCellStyle(headerCellStyle);
    cellHeader.setCellValue("Tổng số đơn hàng bị hủy");
